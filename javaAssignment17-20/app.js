...
var userInput = prompt('WellCom To My Bakery What do you Want to Order sir/maam');

var found = false 

for (var i = 0; i < bakeryItems.length; i++){

  if (a[i].toLoverCase() === userInput) {
    console.log('Cookie is <h2> available </h2>at ');
  found = true;
  break
  }
  else {
    console.log('Cookie is <h2> Unavailable</h2> at ');
  }
  }